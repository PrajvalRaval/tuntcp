...
sudo iptables -A INPUT -i 192.0.3.2 -j ACCEPT
sudo iptables -A FORWARD -i 192.0.2.2 -s 192.0.3.2 -j ACCEPT
sudo iptables -A FORWARD -i 192.0.3.2 -o 192.0.2.2 -m state --state RELATED,ESTABLISHED -j ACCEPT
